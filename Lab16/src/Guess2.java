...
/**
 * The Guess2 class is an application that uses a Random object to to play a
 * number guessing game with one computer player and one human player.
 *
 * Bugs: The old bugs have been fixed by we've introduced new one. Can you find
 * them? //YOU WILL ONLY NEED TO MAKE MINOR CHANGES/ADDITIONS TO FIX THEM!
 * 
...
public class Guess2 {
	...
	public static void main(String[] args) {
		...
		Random ranGen = new Random(6); // seeded to make debugging easier
